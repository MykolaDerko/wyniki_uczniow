...
ggplot(dane_zwalidowane, aes(x = Exam_Score))+
  geom_histogram(binwidth =5, fill ="steelblue", color ="black")+
  theme_minimal()+
  labs(title ="Rozkład wyników egzaminów w zależności od trudności w nauce", x ="Wynik egzaminu", y ="Liczba uczniów")+
...
# To może też do poprawy ? może połączyć z tym poprzednim?
...
Poniższy wykres kołowy pokazuje procentowy podział zmiennej *Family_Income*. \* 19,2% należy do kategorii *High*, czyli wysokie dochody rodziny \* 40,3% należy do kategorii *Medium*, czyli średnie dochody rodziny \* 40,5% należy do kategorii *Low*, czyli niskie dochody rodziny
